...
enum Model {
  static let modelInfo: FileInfo = (name: "model1", extension: "tflite")
...
//    guard let thumbnailPixelBuffer = resizePixelBuffer(
//      pixelBuffer,width: Int(scaledSize.width), height: Int(scaledSize.height)) else {
//        return nil
//    }
